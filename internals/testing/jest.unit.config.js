...
module.exports = {
  ...
  setupFiles: ['<rootDir>/internals/testing/env.js', '<rootDir>/internals/testing/setup.js'],
  clearMocks: true,
  resetMocks: true,
  globals: {
    NODE_ENV: 'test',
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(@capillarytech|@antv|antd|rc-pagination|rc-calendar|lodash-es|@bugsnag|ml-matrix)/)',
  ],
  coveragePathIgnorePatterns: ['.integration.test.', '.mockdata.', '.mockData.'],
