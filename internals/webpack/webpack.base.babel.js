...
module.exports = (options) => ({
    ...
    rules: [
      {
        ...
        exclude:
          /node_modules\/(?!@capillarytech)|cap-react-ui-library|cap-style-guide|cap-ui-library/,
      },
      {
        ...
        exclude:
          /cap-react-ui-library\/node_modules|cap-style-guide\/node_modules|cap-ui-library\/node_modules/,
      },
      {
        test: /\.scss$/,
        exclude: (filepath) => {
          return (
            (/node_modules/.test(filepath) && !/@capillarytech/.test(filepath)) ||
            /\/app\//.test(filepath)
          );
        },
        use: [
  ...
  resolve: {
    ...
    alias: {
      ...
      '@capillarytech/cap-ui-library': path.resolve('node_modules/@capillarytech/cap-ui-library/'),
      '@capillarytech/cap-ui-utils': path.resolve('node_modules/@capillarytech/cap-ui-utils/'),
      immutable: path.resolve('node_modules/immutable'),
      'connected-react-router/immutable': path.resolve(
        'node_modules/connected-react-router/immutable',
      ),
