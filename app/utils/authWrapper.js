...
import { isRewardsCatalogFeatureEnabled } from './commonUtils';
...
export const userIsAuthenticatedWrapper = connectedAuthWrapper(userIsAuthenticatedDefaults);
...
const hasRewardsCatalog = () => isRewardsCatalogFeatureEnabled();

export const isRewardsCatalogEnabled = connectedRouterRedirect({
  authenticatedSelector: hasRewardsCatalog,
  redirectPath: `/not-enabled`,
  wrapperDisplayName: 'RewardsCatalogEnabled',
  allowRedirectBack: false,
});
